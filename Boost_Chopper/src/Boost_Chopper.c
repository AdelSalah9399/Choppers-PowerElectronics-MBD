...
void Boost_Chopper_projection(void)
{
...
static void rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  ...
  rtsiSetT(si, tnew);
  Boost_Chopper_step();
  Boost_Chopper_projection();
  rtsiSetSimTimeStep(si,MAJOR_TIME_STEP);
}

/* Model step function */
void Boost_Chopper_step(void)
{
  ...
  if (rtmIsMajorTimeStep(rtM)) {
    ...
    {
      /* Update absolute timer for sample time: [1.25E-5s, 0.0s] */
      /* The "clockTick1" counts the number of times the code of this task has
       * been executed. The resolution of this integer timer is 1.25E-5, which is the step size
...
void Boost_Chopper_derivatives(void)
{
...
void Boost_Chopper_initialize(void)
{
  /* Registration code */
  ...
  /* Initialize timing info */
  {
    ...
    rtM->Timing.sampleTimes[1] = (1.25E-5);
  ...
  rtmSetTFinal(rtM, -1);
  rtM->Timing.stepSize0 = 1.25E-5;
  rtM->solverInfoPtr = (&rtM->solverInfo);
  rtM->Timing.stepSize = (1.25E-5);
  rtsiSetFixedStepSize(&rtM->solverInfo, 1.25E-5);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Boost_Chopper/<S21>/State-Space (sfun_spid_contc) */
    {
      SimStruct *rts = rtM->childSfunctions[0];
      ...
      /* inputs */
      {
        ...
        /* port 1 */
        {
          ...
          sfcnUPtrs[1] = &rtConstP.pooled2;
          sfcnUPtrs[2] = &rtConstP.pooled2;
      ...
      ssSetPath(rts, "Boost_Chopper/powergui/EquivalentModel1/State-Space");

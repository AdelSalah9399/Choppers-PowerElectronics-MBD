...
#ifndef RTW_HEADER_Boost_Chopper_h_
#define RTW_HEADER_Boost_Chopper_h_
#include <stddef.h>
#include <string.h>
#ifndef Boost_Chopper_COMMON_INCLUDES_
#define Boost_Chopper_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#endif                                 /* Boost_Chopper_COMMON_INCLUDES_ */

#include "Boost_Chopper_types.h"
...
extern void Boost_Chopper_initialize(void);
extern void Boost_Chopper_step(void);
 ...
 *
 * '<Root>' : 'Boost_Chopper'
 * '<S1>'   : 'Boost_Chopper/Current Measurement'
 * '<S2>'   : 'Boost_Chopper/DC Voltage Source'
 * '<S3>'   : 'Boost_Chopper/Diode'
 * '<S4>'   : 'Boost_Chopper/Mosfet'
 * '<S5>'   : 'Boost_Chopper/Voltage Measurement'
 * '<S6>'   : 'Boost_Chopper/Voltage Measurement1'
 * '<S7>'   : 'Boost_Chopper/powergui'
 * '<S8>'   : 'Boost_Chopper/Current Measurement/Model'
 * '<S9>'   : 'Boost_Chopper/DC Voltage Source/Model'
 * '<S10>'  : 'Boost_Chopper/Diode/Model'
 * '<S11>'  : 'Boost_Chopper/Diode/Model/Measurement list'
 * '<S12>'  : 'Boost_Chopper/Mosfet/Diode'
 * '<S13>'  : 'Boost_Chopper/Mosfet/Ideal Switch'
 * '<S14>'  : 'Boost_Chopper/Mosfet/Measurement list'
 * '<S15>'  : 'Boost_Chopper/Mosfet/Diode/Model'
 * '<S16>'  : 'Boost_Chopper/Mosfet/Diode/Model/Measurement list'
 * '<S17>'  : 'Boost_Chopper/Mosfet/Ideal Switch/Model'
 * '<S18>'  : 'Boost_Chopper/Mosfet/Ideal Switch/Model/Measurement list'
 * '<S19>'  : 'Boost_Chopper/Voltage Measurement/Model'
 * '<S20>'  : 'Boost_Chopper/Voltage Measurement1/Model'
 * '<S21>'  : 'Boost_Chopper/powergui/EquivalentModel1'
 * '<S22>'  : 'Boost_Chopper/powergui/EquivalentModel1/Gates'
 * '<S23>'  : 'Boost_Chopper/powergui/EquivalentModel1/Sources'
 * '<S24>'  : 'Boost_Chopper/powergui/EquivalentModel1/Status'
 * '<S25>'  : 'Boost_Chopper/powergui/EquivalentModel1/Yout'
 */
#endif                                 /* RTW_HEADER_Boost_Chopper_h_ */

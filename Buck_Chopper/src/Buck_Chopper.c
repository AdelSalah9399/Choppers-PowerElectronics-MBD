...
#include "Buck_Chopper.h"
#include "Buck_Chopper_private.h"
...
void Buck_Chopper_projection(void)
{
...
static void rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  ...
  rtsiSetT(si, tnew);
  Buck_Chopper_step();
  Buck_Chopper_projection();
  rtsiSetSimTimeStep(si,MAJOR_TIME_STEP);
}

/* Model step function */
void Buck_Chopper_step(void)
{
...
void Buck_Chopper_derivatives(void)
{
...
void Buck_Chopper_initialize(void)
{
  /* Registration code */
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Buck_Chopper/<S21>/State-Space (sfun_spid_contc) */
    {
      SimStruct *rts = rtM->childSfunctions[0];
      ...
      ssSetPath(rts, "Buck_Chopper/powergui/EquivalentModel1/State-Space");

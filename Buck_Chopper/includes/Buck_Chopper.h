...
#ifndef RTW_HEADER_Buck_Chopper_h_
#define RTW_HEADER_Buck_Chopper_h_
#include <stddef.h>
#include <string.h>
#ifndef Buck_Chopper_COMMON_INCLUDES_
#define Buck_Chopper_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#endif                                 /* Buck_Chopper_COMMON_INCLUDES_ */

#include "Buck_Chopper_types.h"
...
extern void Buck_Chopper_initialize(void);
extern void Buck_Chopper_step(void);
 ...
 *
 * '<Root>' : 'Buck_Chopper'
 * '<S1>'   : 'Buck_Chopper/Current Measurement'
 * '<S2>'   : 'Buck_Chopper/DC Voltage Source'
 * '<S3>'   : 'Buck_Chopper/Diode'
 * '<S4>'   : 'Buck_Chopper/Mosfet'
 * '<S5>'   : 'Buck_Chopper/Voltage Measurement'
 * '<S6>'   : 'Buck_Chopper/Voltage Measurement1'
 * '<S7>'   : 'Buck_Chopper/powergui'
 * '<S8>'   : 'Buck_Chopper/Current Measurement/Model'
 * '<S9>'   : 'Buck_Chopper/DC Voltage Source/Model'
 * '<S10>'  : 'Buck_Chopper/Diode/Model'
 * '<S11>'  : 'Buck_Chopper/Diode/Model/Measurement list'
 * '<S12>'  : 'Buck_Chopper/Mosfet/Diode'
 * '<S13>'  : 'Buck_Chopper/Mosfet/Ideal Switch'
 * '<S14>'  : 'Buck_Chopper/Mosfet/Measurement list'
 * '<S15>'  : 'Buck_Chopper/Mosfet/Diode/Model'
 * '<S16>'  : 'Buck_Chopper/Mosfet/Diode/Model/Measurement list'
 * '<S17>'  : 'Buck_Chopper/Mosfet/Ideal Switch/Model'
 * '<S18>'  : 'Buck_Chopper/Mosfet/Ideal Switch/Model/Measurement list'
 * '<S19>'  : 'Buck_Chopper/Voltage Measurement/Model'
 * '<S20>'  : 'Buck_Chopper/Voltage Measurement1/Model'
 * '<S21>'  : 'Buck_Chopper/powergui/EquivalentModel1'
 * '<S22>'  : 'Buck_Chopper/powergui/EquivalentModel1/Gates'
 * '<S23>'  : 'Buck_Chopper/powergui/EquivalentModel1/Sources'
 * '<S24>'  : 'Buck_Chopper/powergui/EquivalentModel1/Status'
 * '<S25>'  : 'Buck_Chopper/powergui/EquivalentModel1/Yout'
 */
#endif                                 /* RTW_HEADER_Buck_Chopper_h_ */
